                        ...
                        <div class="row g-4">
                            ...
                            <div class="bg-secondary text-center rounded p-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <h5 ><a href="ProductDashboard?action=hide">Tất cả sản phẩm</a></h5>
                                    <form action="ProductDashboard?action=hide" method="post">
                                        <div class="input-group">
                                            <input type="text" class="form-control bg-dark border-0" placeholder="Tìm tên sản phẩm" name="search">
                                    ...
                                    <button style="    background: #3AA6B9;
                                            text-decoration: none;
                                            border: none;
                                            height: 2.5rem;
                                            border-radius: 10px;"><a href="ProductDashboard?action=show" style="color: white">Xem tất cả sản phẩm</a></button>                                </div>
                                <div class="table-responsive">
                                    ...
                                    <nav style="float: right;margin-top: 25px; color: black" aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <c:if test="${tag > 1}">
                                                <li  class="page-item"><a style="color: black"  class="page-link" href="ProductDashboard?indexPage=${tag-1}&amp;action=${action}"">Trước</a></li>
                                                </c:if>
                                                ...
                                                <li class="page-item"><a style="color: black"  class="page-link" href="ProductDashboard?indexPage=${tag+1}&amp;action=${action}">Tiếp</a></li>
                                                </c:if>
                                        </ul>
                                    </nav>
                                </div>
