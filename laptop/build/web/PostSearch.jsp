                        ...
                        <div class="d-inline-flex align-items-center">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <button class="dropdown-item" type="button"><a href="signup">Đăng ký</a></button>
                                </div>
                            </div>
                        </div>
                    </c:if>
                    <c:if test="${account != null}">
                        <div class="d-inline-flex align-items-center">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                     <button class="dropdown-item" type="button"><a href="mypurchase">Đơn mua của tôi</a></button>
            
                                    <button class="dropdown-item" type="button"><a href="UserProfile?aid=${account.getAccountID()}">Thông tin</a></button>
...
<!--                Thanh search-->
                <div class="col-lg-4 col-6 text-left">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Bạn đang tìm kiếm điều gì?" name="search">
        ...
        <section id="blog">
            <c:if test="${size < 1}">
                <div class="blog-heading">
                    <span>Chúng ta có gì ngày hôm nay?</span>
                    <h3>Rất tiếc! Không có thông tin</h3>
                </div>
            </c:if>
            <c:if test="${size > 0}">
                <div class="blog-heading">
                    ...
                    <c:forEach items="${requestScope.postDTOs}" var="c">
                        <div class="blog-box">
                            ...
                            <div class="blog-text">
                                ...
                                <a href="postDetail?postID=${c.getPostID()}">Đọc thêm</a>
