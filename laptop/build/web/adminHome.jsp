                    ...
                    <div class="row g-4">
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="ms-3">
                                    <p class="mb-2">Khách hàng mới hôm nay</p>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="ms-3">
                                    <p class="mb-2">Sản phẩm mới hôm nay</p>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                                ...
                                <div class="ms-3">
                                    <p class="mb-2">Đơn đặt hôm nay</p>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4" style="background-color: #22A699;">
                                ...
                                <div class="ms-3">
                                    <p class="mb-2" style="color: white">Doanh thu hôm nay</p>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4" >
                                <i class="bx bx-shopping-bag fa-3x text-primary"></i>
                                <div class="ms-3">
                                    <p class="mb-2" >Số đơn hàng đã giao</p>
                        ...
                        <div class="col-sm-6 col-xl-3">
                            <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4" >
                                ...
                                <div class="ms-3">
                                    <p class="mb-2" >Số đơn hàng đã hủy</p>
                                    <h6 class="mb-0" >${totalOrderDelivered}</h6>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-secondary text-center rounded p-4">
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <h6 class="mb-0">Sale gần đây</h6>
                            <a href="tableOrder">Hiển thị tất cả</a>
                        </div>
                                                ...
                                                <c:if test="${la.getStatus() != 4 && la.getStatus() != 3}">
                                                    <select class="form-select form-select-sm col-md-3" aria-label=".form-select-sm example" onchange="handleOptionChange(this)">
                                                        <c:if test="${la.getStatus() == 0}">
                                                            ...
                                                            <option value="1" name="${la.getOrderID()}">Xác nhận và đóng hàng</option>
                                                            <option value="2" name="${la.getOrderID()}">Đang được vận chuyển</option>
                                                        ...
                                                        <c:if test="${la.getStatus() == 1}">
                                                            <option>Xác nhận và đóng hàng</option>
                                                        ...
                                                        <c:if test="${la.getStatus() == 2}">
                                                            <option>Đang được vận chuyển</option>
                                                            <option value="0" name="${la.getOrderID()}">Đang chờ tiến hành</option>
                                                            <option value="1" name="${la.getOrderID()}">Xác nhận và đóng hàng</option>
                                                            <option value="3" name="${la.getOrderID()}">Đã giao hàng</option>
                                                            <option value="4" name="${la.getOrderID()}">Hủy đơn</option>
