                        ...
                        <div class="">
                            <div class="bg-secondary rounded h-100 p-4">
                                ...
                                <form action="tableVoucher" method="POST" onsubmit="return validateForm()">
                                    <div class="left-side">
                                        ...
                                        <button type="submit" class="btn btn-primary">Thêm Voucher mới</button>
                                    ...
                                    <div class="right-side">
                                        ...
                                        <a class="btn btn-primary" onclick="generateCode()">Tạo mã</a>
                                    </div>
                            ...
                            <div class="bg-secondary text-center rounded p-4">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <h6 class="mb-0">Tất cả Voucher</h6>
                                </div>
