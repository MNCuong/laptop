                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="tableAccount" class="dropdown-item">Tài khoản</a>
                            <a href="tableCategory" class="dropdown-item">Danh mục</a>
                            <a href="ProductDashboard" class="dropdown-item">Sản phẩm</a>
                            <a href="tableOrder" class="dropdown-item">Đơn đặt</a>
...
<!--                    <a href="widget.html" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Widgets</a>
                    ...
                    <a href="Charts" class="nav-item nav-link active"><i class="fa fa-chart-bar me-2"></i>Biểu đồ</a>
<!--                    <div class="nav-item dropdown">
