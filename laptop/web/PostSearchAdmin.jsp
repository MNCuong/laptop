            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-secondary navbar-dark">
                    <a href="admin" class="navbar-brand mx-4 mb-3">
                        <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Trang chủ Admin</h3>
                    </a>
                        ...
                        <div class="row g-4">
                            <div class="col-sm-12 col-xl-6 ">
                                <div class="bg-secondary rounded h-100 p-4">
                                    <h6 >Tất cả các danh mục bài viết</h6>
                            ...
                            <div class="col-sm-12 col-xl-6 ">
                                <div class="bg-secondary rounded h-100 p-4">
                                    <h6 class="mb-4" ">Thêm danh mục bài viết mới</h6>
                                    <form action="AddPostCategory" method="POST" onsubmit="return validateForm();">
                                        ...
                                        <button type="submit" class="btn btn-primary">Thêm danh muc mới</button>
                                    </form>
                            ...
                            <div class="bg-secondary text-center rounded p-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <form action="tableCategory" method="POST">       
                                        <a href="postDashboard" class="btn btn-primary">Tất cả các bài viết</a>
                                        <a href="AddPost" class="btn btn-primary">Thêm bài viết</a>
                                    </form>
                                     <form action="postDashboard" method="post">
                                        <div class="input-group">
                                            <input type="text" class="form-control bg-dark border-0" placeholder="Tìm kiếm bài viết" name="search">
