                            ...
                            <div class="bg-secondary text-center rounded p-4">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    ...
                                    <div class="bg-secondary rounded h-100 p-4">
                                        ...
                                        <h5 ><a href="ProductDashboard?action=show">Tất cả sản phẩm</a></h5>
                                    </div>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <button style="    background: #22A699;
                                            ...
                                            border: none;
                                            height: 2.3rem;
                                            border-radius: 5px; margin-top: 25px"><a href="ProductDashboard?action=hide" style="color: white">Ẩn sản phẩm</a>
                                    </button>

                                    <nav style="float: right;margin-top: 25px; color: black" aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <c:if test="${tag > 1}">
                                                <li  class="page-item"><a style="color: black"  class="page-link" href="ProductDashboard?indexPage=${tag-1}&amp;action=${action}"">Sau</a></li>
                                                </c:if>
