                        ...
                        <div class="row g-4">
                            <div class="">
                                <div class="bg-secondary rounded h-100 p-4">
                                    <button onclick="toggleScreen1()" class="btn btn-primary">Chi tiết sản phẩm</button>
                                    <button onclick="toggleScreen2()" class="btn btn-primary">Ảnh sản phẩm</button>
                                    <hr>
                                        ...
                                        <div class="row">
                                            <div class=""  id="detailProduct">
                                                <div class="left-side">
                                                    ...
                                                    <div class="col-md-6" style="display: flex;
                                                        ...
                                                        <label class="form-label" style="    font-weight: bold;
                                                               margin-bottom: 5px;">Dung lượng Ram</label>
                                                        <input type="text" value="${ramOld}" class="form-control col-3" name="ram" id="ram" placeholder="" style="margin-bottom: 1rem">
                                                    ...
                                                    <div class="col-md-6" style="display: flex;
                                                         ...
                                                         margin-bottom: 20px;">
                                                        <label class="form-label" style="    font-weight: bold;
                                                               margin-bottom: 5px; ">Dung lượng lưu trữ</label>
                                                ...
                                                <div class="right-side">
                                                    ...
                                                    <button type="submit"   class="btn btn-primary" style="margin-top: 30px" value="product" name="update">Cập nhật chỉnh sửa</button> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="" id="imgProduct">
                                                <div class="left-side"> <p>Image Description</p>
                                                    ...
                                                    <button type="submit"   class="btn btn-primary" style="margin-top: 30px" value="image" name="update" >Chỉnh sửa ảnh</button> 
                                                    <button type="submit"   class="btn btn-primary" style="margin-top: 30px" value="delete" name="update" >Xóa ảnh</button> </div>
                                                <div class="right-side"> 
                                                    <div id="inputContainer">
                                                    </div>
                                                    <button type="button" class="btn btn-primary" style="margin-top: 30px" onclick="addImageInput()">Thêm ảnh</button>
