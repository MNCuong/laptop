                    ...
                    <div class="col-12">
                        <div class="thead-dark">
                            ...
                            <c:if test="${p.status == 0}">
                                <span>|</span>
                                <span style="font-weight: bold;color: #7A9D54">Đang chờ tiến hành</span>
                                <span>|</span>
                            ...
                            <c:if test="${p.status == 2}">
                                <span>|</span>
                                <span style="font-weight: bold;color: #7A9D54">Đang vận chuyển</span>
                                <span>|</span>
                                <span><a href="ordertracking?orderid=${p.orderID}&acountid=${account.getAccountID()}" style="color: #BF9742">Theo dõi đơn hàng</a></span>
                            ...
                            <c:if test="${p.status == 3}">
                                <span>|</span>
                                <span style="font-weight: bold;color: #4FC0D0">Đã giao hàng</span>
                                <span>|</span>
                                <span><a href="ordertracking?orderid=${p.orderID}&acountid=${account.getAccountID()}" style="color: #BF9742">Theo dõi đơn hàng</a></span>
