...
<html lang="en">
    ...
    <body>
            ...
            <div class="row px-xl-5">
                <div class="col-12">
                    <nav class="breadcrumb bg-light mb-30">
                        ...
                        <a class="breadcrumb-item text-dark" href="mypurchase">Giao dịch mua hàng của tôi</a>
                        <span class="breadcrumb-item active">Theo dõi đơn hàng</span>
                    </nav>
                </div>
            </div>
        </div>
                    ...
                    <div class="well">
                        ...
                        <div class="order-status">
                            ...
                            <div class="image-order-status image-order-status-new active img-circle">
                                <span class="status">Đã được nhận</span>
                                <div class="icon"></div>
                            </div>
                            <div class="image-order-status image-order-status-active active img-circle">
                                <span class="status">Đang trong quá trình </span>
                                <div class="icon"></div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="row px-xl-5 ">
                <div class="col-12">
                    <h4 class="thead-dark">Đơn hàng của bạn</h4>
                    ...
                    <div >
                        <table class="table table-bordered custom-table ">
                            ...
                            <tbody>
                                <tr>
                                    <td class="align-right" colspan="100">Giá trị đơn hàng</td>
                                    <td class="small-text align-right" colspan="1">${totalAmount}$</td>
                                </tr>
                                <tr>
                                    <td class="align-right" colspan="100">Phí vận chuyển</td>
                                    <td class="small-text align-right" colspan="1">10$</td>
                                </tr>
                                <tr>
                                    <td class="align-right" colspan="100">Đã áp dụng Phiếu giảm giá</td>
                                ...
                                <tr>
                                    <td  class="align-right" colspan="100">Tổng giá trị: </td>
